...
public abstract class cPOA extends org.omg.PortableServer.Servant
 implements common.cOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // common/c/getAvailableTimeSlot
       {
         String date = in.read_string ();
         String $result = null;
         try {
       ...
       case 4:  // common/c/cancelBooking
       {
         String bookingid = in.read_string ();
         String campus = in.read_string ();
         String $result = null;
         $result = this.cancelBooking (bookingid, campus);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 5:  // common/c/changeReservation
       {
